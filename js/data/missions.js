...
export const MISSIONS = Object.freeze([
  ...
  },
  {
    ...
    host: { id: 'nell', name: 'Nell the Busker', look: { sprite: 'girl-teal', skin: '#f0cdb5', hair: '#7a2f5a', hairStyle: 'bob', top: '#2d5f7a', bottom: '#3b3030', accent: '#e6c26a' } },
    intro: ['Oi! I paint chess positions on the pavement for coins.', 'Solve these four and I\'ll give you my favourite postcard. They all end on the back rank, like my career.'],
  ...
  },
  {
    ...
    host: { id: 'anton', name: 'Herr Anton', look: { sprite: 'older-brown', skin: '#efcbb0', hair: '#e6e2da', hairStyle: 'bald', top: '#1c1c22', bottom: '#1c1c22', accent: '#f4f1ea' } },
  ...
  },
  {
    ...
    host: { id: 'selin', name: 'Aunt Selin', look: { sprite: 'girl-plum', skin: '#d5a784', hair: '#c9c2b8', hairStyle: 'bun', top: '#7a3a5a', bottom: '#3a3348', accent: '#e8b04a' } },
  ...
  },
  {
    ...
    host: { id: 'vel', name: 'Coach Vel', look: { sprite: 'old-bluescarf', skin: '#7a4c33', hair: '#d8d4cc', hairStyle: 'short', top: '#f2efe4', bottom: '#8a6a4a', accent: '#c2410c' } },
  ...
  },
  {
    ...
    host: { id: 'hu', name: 'Old Master Hu', look: { sprite: 'old-plum', skin: '#e3bd98', hair: '#eeeeee', hairStyle: 'long', top: '#3d5a4a', bottom: '#2a2a2a', accent: '#d9b25a' } },
