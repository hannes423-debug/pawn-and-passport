...
export const CLUBS = Object.freeze([
  {
    ...
    starPlayerId: 'maya',
    regularOpponentPool: [
      { id: 'nyc-tony', name: 'Tony Delgado', style: 'aggressive', look: { sprite: 'young-blue', skin: '#d9a07a', hair: '#3b2a20', hairStyle: 'short', top: '#3d6ea8', bottom: '#2a2a2a' } },
      { id: 'nyc-grace', name: 'Grace Whitfield', style: 'positional', look: { sprite: 'woman', skin: '#f1cfb4', hair: '#d9b46a', hairStyle: 'long', top: '#6aa36f', bottom: '#3a3a4a' } },
      { id: 'nyc-jamal', name: 'Jamal Pierce', style: 'tactical', look: { sprite: 'young-red', skin: '#6e4630', hair: '#141414', hairStyle: 'short', top: '#e0b43c', bottom: '#2d3b55' } },
      { id: 'nyc-rosa', name: 'Rosa Kim', style: 'balanced', look: { sprite: 'girl', skin: '#edc9a5', hair: '#1b1b22', hairStyle: 'bob', top: '#b04a7a', bottom: '#2c2c3a' } }
    ],
  ...
  },
  {
    ...
    casualLocationName: 'Covent Garden Chess Courtyard',
    openingId: 'london',
    starPlayerId: 'oliver',
    regularOpponentPool: [
      { id: 'lon-harriet', name: 'Harriet Cole', style: 'positional', look: { sprite: 'woman', skin: '#f2d2bc', hair: '#6b3e26', hairStyle: 'bob', top: '#2f4f6f', bottom: '#3b3b3b' } },
      ...
      { id: 'lon-declan', name: 'Declan Frost', style: 'defensive', look: { sprite: 'young-blue', skin: '#f4d6c3', hair: '#c46a2e', hairStyle: 'short', top: '#4a6b4a', bottom: '#333' } },
      { id: 'lon-imogen', name: 'Imogen Hale', style: 'balanced', look: { sprite: 'girl', skin: '#efcdb3', hair: '#e2c27a', hairStyle: 'long', top: '#7a5ca8', bottom: '#2b2b33' } }
    ],
  ...
  },
  {
    ...
    starPlayerId: 'clara',
    regularOpponentPool: [
      { id: 'vie-felix', name: 'Felix Brandt', style: 'tactical', look: { sprite: 'young-blue', skin: '#f0cdb2', hair: '#4a3222', hairStyle: 'short', top: '#7a2e3b', bottom: '#2c2c2c' } },
      { id: 'vie-lena', name: 'Lena Hofer', style: 'balanced', look: { sprite: 'girl', skin: '#f4d7c1', hair: '#caa25a', hairStyle: 'braid', top: '#2f5f5a', bottom: '#3a3040' } },
      { id: 'vie-matthias', name: 'Matthias Gruber', style: 'positional', look: { sprite: 'old-green', skin: '#ecc8ab', hair: '#8b8680', hairStyle: 'short', top: '#4b4b6b', bottom: '#2b2b2b' } },
      { id: 'vie-sophie', name: 'Sophie Lang', style: 'aggressive', look: { sprite: 'woman', skin: '#f1cfb8', hair: '#2b1d17', hairStyle: 'bun', top: '#c9763a', bottom: '#2e3444' } }
    ],
  ...
  },
  {
    ...
    casualLocationName: 'Bosphorus Tea Garden',
    openingId: 'sicilian',
    starPlayerId: 'emre',
    regularOpponentPool: [
      { id: 'ist-deniz', name: 'Deniz Arslan', style: 'aggressive', look: { sprite: 'young-blue', skin: '#cf9f7a', hair: '#231a16', hairStyle: 'short', top: '#2b5d8a', bottom: '#2f2f2f' } },
      { id: 'ist-ayla', name: 'Ayla Demir', style: 'tactical', look: { sprite: 'woman', skin: '#dcae8a', hair: '#3a2419', hairStyle: 'long', top: '#a33b4a', bottom: '#2d2a38' } },
      { id: 'ist-kerem', name: 'Kerem Yildiz', style: 'practical', look: { sprite: 'boy', skin: '#c89670', hair: '#141414', hairStyle: 'curly', top: '#5a7a3a', bottom: '#33302b' } },
      { id: 'ist-zeynep', name: 'Zeynep Aydin', style: 'balanced', look: { sprite: 'girl', skin: '#e2b894', hair: '#5a321e', hairStyle: 'bob', top: '#d6a23a', bottom: '#2b3040' } }
    ],
  ...
  },
  {
    ...
    starPlayerId: 'zhou',
    regularOpponentPool: [
      { id: 'wen-hao', name: 'Zhang Hao', style: 'defensive', look: { sprite: 'young-blue', skin: '#e6c09a', hair: '#161616', hairStyle: 'short', top: '#2f4f3f', bottom: '#2b2b2b' } },
      { id: 'wen-mei', name: 'Li Mei', style: 'positional', look: { sprite: 'woman', skin: '#edc9a6', hair: '#1c1418', hairStyle: 'bob', top: '#b03a3a', bottom: '#2a2f3f' } },
      { id: 'wen-jun', name: 'Wang Jun', style: 'practical', look: { sprite: 'boy', skin: '#e1b890', hair: '#101014', hairStyle: 'short', top: '#3a4f8a', bottom: '#33302b' } },
      { id: 'wen-xiu', name: 'Chen Xiu', style: 'tactical', look: { sprite: 'girl', skin: '#ebc5a2', hair: '#1a1a1f', hairStyle: 'bun', top: '#d0a040', bottom: '#2d2a38' } }
    ],
