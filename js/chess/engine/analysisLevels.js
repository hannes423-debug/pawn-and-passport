/**
 * analysisLevels.js — the six strength/assistance bands the game speaks in.
 *
...
export const ANALYSIS_LEVELS = Object.freeze([
  {
    id: LEVELS.BEGINNER, label: 'Beginner', order: 0,
    depth: 4, nodes: 6000, movetime: 120, multiPv: 2,
    skillLevel: 1, uciElo: 1320,
    note: 'Shallow search. Misses most tactics beyond one move.'
  },
  {
    id: LEVELS.CLUB, label: 'Club', order: 1,
  ...
  {
    id: LEVELS.ADVANCED, label: 'Advanced', order: 2,
