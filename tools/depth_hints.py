...
The fourth item is the old hand-set FOOTPRINT (percent rect) where there was
one, else None: the part of the floor the object stands on. Only the plants
use it - the floor behind a plant opens up for walking (build_occlusion.py,
PLANT), and it is the footprint that says where "behind" begins: a planter's
footprint is its whole box, a potted plant's just the pot.
"""

# scene -> [(id, (x0, y0, x1, y1) percent, base percent, footprint rect | None), ...]
HINTS = {
    'lon-venue': [
